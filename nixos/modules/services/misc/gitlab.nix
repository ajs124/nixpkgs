...
in {
  ...
  config = mkIf cfg.enable {
    ...
    assertions = [
      ...
      {
        assertion = versionAtLeast postgresqlPackage.version "14.0.0";
        message = "PostgreSQL >=14 is required to run GitLab 17. Follow the instructions in the manual section for upgrading PostgreSQL here: https://nixos.org/manual/nixos/stable/index.html#module-services-postgres-upgrading";
      }
    ];
